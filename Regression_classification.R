...
for (i in 1:100) {
  #Pred
  #setwd("~/Documents/HSI/Soil/Paper_2_Quantitative/M1")
  setwd("~/Documents/HSI/Soil/Paper_2_Quantitative/M2")
  ...
  #write.csv(data_texture, file = paste0("~/Documents/HSI/Soil/Paper_2_Quantitative/M1/OP/iter_tt_",i,".csv"), quote = TRUE, eol = "\n", na = "-9999", row.names = FALSE)
  write.csv(data_texture, file = paste0("~/Documents/HSI/Soil/Paper_2_Quantitative/M2/OP/iter_tt_",i,".csv"), quote = TRUE, eol = "\n", na = "-9999", row.names = FALSE)
}
